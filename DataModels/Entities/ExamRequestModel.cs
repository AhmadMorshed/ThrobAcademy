...
namespace Throb.Data.Entities
{
    public class ExamRequestModel
    {
        ...
        public List<Question> Questions { get; set; } = new List<Question>(); // الأسئلة المولدة
        [NotMapped]
        public List<Question> ManualQuestions { get; set; } = new List<Question>(); // الأسئلة اليدوية
    }
}